...
export default function PetProfile(props) {
  ...
  const buttonThreeEightFiveZeroSixThreeFourOnClick = useDataStoreDeleteAction({
    id: pet?.id,
    model: Pet,
    schema: schema,
  });
  return (
    ...
    >
      <Button
        ...
        children="Delete"
        onClick={() => {
          buttonThreeEightFiveZeroSixThreeFourOnClick();
        }}
        {...getOverrideProps(overrides, "Button3850634")}
      ></Button>
      <Image
        width="141px"
        height="142px"
      ...
      >
        ...
        <Button
          ...
          variation="primary"
          children="Update"
          {...getOverrideProps(overrides, "Button3850532")}
        ></Button>
      </Flex>
    </Flex>
  );
